...
//    }
    ...
    public Integer findNumberOfPeopleOn(Date date, String airportName) {
        ...
        Map<Integer, ArrayList<Integer>> flightPassengerMap = airportRepository.getAllFlightBookings();
        ...
        for (Flight flight : flights) {
            if (flight.getFlightDate().equals(date) && (flight.getFromCity().equals(city) || flight.getToCity().equals(city))) {
                ...
                ArrayList<Integer> passengerList = flightPassengerMap.get(flight);
                //List <Passenger> passengers = flightPassengerMap.get(new ArrayList<Integer>);
